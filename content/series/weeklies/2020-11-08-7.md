...
tags:
  - 周刊
title: 周刊第七期：如何学习
excerpt: '如何学习, 环保的编程语言, Google 新 Logo, Windows XP in React, Lobe'
date: '2020-11-08 15:15:00 +0800'
redirectFrom:
  - /weekly-7
  - /articles/weekly-7
coverImage: /weeklies/7-learning-to-learn.png
---
...
原文: [Learning to Learn](https://www.simplethread.com/learning-to-learn/)
...
![Bloom’s Taxonomy Pyramid](/posts/weekly-7-blooms-taxonomy_upside_down_pyramid.png)
...
![dikiw](/posts/weekly-7-data-info-knowledge-insight-wisdom-dikiw.png)
...
作者将这次学习 Web 框架的经历还写了另一篇博文 [Ruby on Rails in a Week](https://www.simplethread.com/ruby-on-rails-in-a-week/)。回顾我之前学习 Ruby on Rails 的经历，我觉得 Web 技术、Ruby 语言基础是学习前的必备知识；跟着网上的资料做了一些 Rails 应用，这些实践帮助学习掌握了 Rails。但让我真正理解 Rails 的是一本叫 *Rebuilding Rails* 的书，我按照书中的指导从零实现了一遍简易版的 Rails 框架后，才真正领悟到了 Rails 的思想。这种以实现该技术本身的方式虽然会比较耗费精力，但却是很有效果的一种方法，特别是在软件领域。我认识到的人中也有在做这方面的努力，geektutu 有个[“七天从零实现”系列](https://geektutu.com/post/gee.html)就是棒的学习 Go 语言的参考。

## 文摘

### 1. 哪种编程语言最环保

原文: [Which Programming Languages Use the Least Electricity?](https://thenewstack.io/which-programming-languages-use-the-least-electricity/)
...
原文: [I am Seriously Considering Going Back to Desktop Computers](http://misc-stuff.terraaeon.com/articles/locked-down-computers.html)
...
原文: [Google’s new logos are bad](https://techcrunch.com/2020/10/06/googles-new-logos-are-bad/)
...
原文: [The World Needs Nuclear Power, And We Shouldn’t Be Afraid Of It](https://www.forbes.com/sites/startswithabang/2020/10/21/the-world-needs-nuclear-power-and-we-shouldnt-be-afraid-of-it/?sh=7124d4216576)
...
链接: [Windows XP in React](https://winxp.now.sh/)

一位网友用 React 实现了模拟 Windows XP 的页面，里面的扫雷游戏甚至可以玩。该应用已开源，有人给它贡献了 Winamp 播放功能和 画图功能。

### 2. 无需编码轻松创建机器学习模型

链接: [Lobe: Machine Learning Made Easy](https://lobe.ai/)
...
链接: [No More Google](https://nomoregoogle.com/)

该网站列出了一些 Google 服务的替代品，以防止 Google 追踪个人隐私。另外，个人的数据如果都放在了 Google 上，一旦 Google 账号被封，就会导致自己的邮件、照片、文档等全都不能访问，一位网友就遇到了这种情况：[What it's like to get locked out of Google indefinitely](https://www.businessinsider.com/google-users-locked-out-after-years-2020-10)。他的 Google 账号被官方封锁，Google 通知他是因为违反了用户条例，但又没有解释具体是因为什么原因。

### 2. 提示友好的 Git 命令行工具

链接: [Bit is a modern Git CLI](https://github.com/chriswalz/bit)
...
链接: [Merriam-Webster](https://www.merriam-webster.com/dictionary/hector#note-1)
...
词条链接: [Bibliophilia](https://en.wikipedia.org/wiki/Bibliophilia)

词条链接: [Bibliomania](https://en.wikipedia.org/wiki/Bibliomania)
