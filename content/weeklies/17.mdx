...
tags:
  ...
  - Agent
subtitle: >-
  学习四篇博客: 大模型驱动的自主智能体(Lilian
  Weng)/构建高效的智能体(Anthropic)/构建智能体实践指南(OpenAI)/智能体的上下文工程(Manus)
image: weeklies/17-lilian-weng.jpg
description: >-
  周刊第17期: 通过四篇博客学习如何构建智能体(Agent)，大模型驱动的自主智能体(Lilian
  Weng)/构建高效的智能体(Anthropic)/构建智能体实践指南(OpenAI)/智能体的上下文工程(Manus)
---
...
![lilian-weng](https://cdn.hutusi.com/images/weeklies/17-lilian-weng.jpg)
...
![agent-overview](https://cdn.hutusi.com/images/weeklies/17/agent-overview.jpg)
...
![hugging-gpt](https://cdn.hutusi.com/images/weeklies/17/hugging-gpt.jpg)
...
![block-augmented-llm](https://cdn.hutusi.com/images/weeklies/17/block-augmented-llm.webp)
...
![prompt-chaining-workflow](https://cdn.hutusi.com/images/weeklies/17/prompt-chaining-workflow.webp)

2、Routing (路由)

Routing 工作流通过大模型对输入进行分类，并将其定向转到专门的后续任务。常见的案例有：根据用户咨询问题类别导向不同的下游流程，将简单的问题路由到小模型而将困难的问题路由到更大的模型以优化成本和速度。

![routing-workflow](https://cdn.hutusi.com/images/weeklies/17/routing-workflow.webp)
...
![parallelization-workflow](https://cdn.hutusi.com/images/weeklies/17/parallelization-workflow.webp)

4、Orchestrator-workers (协调者-工作者模式)

在协调者-工作者模式的工作流中，协调者是一个中央控制的大模型单元，它分解任务并将其委派给其他大模型工作者，并综合输出结果。

![orchestrator-workers-workflow](https://cdn.hutusi.com/images/weeklies/17/orchestrator-workers-workflow.webp)
...
![evaluator-optimizer-workflow](https://cdn.hutusi.com/images/weeklies/17/evaluator-optimizer-workflow.webp)
...
![autonomous-agent](https://cdn.hutusi.com/images/weeklies/17/autonomous-agent.webp)
...
![openai-single-agent-system](https://cdn.hutusi.com/images/weeklies/17/openai-single-agent-system.jpg)
...
![openai-multi-agent-manager-pattern](https://cdn.hutusi.com/images/weeklies/17/openai-multi-agent-manager-pattern.jpg)

2、去中心化模式(Decentralized pattern): 多个Agent以平等的方式去中心化协作，基于各自专长互相交接任务(agents handing off to agents)。

![openai-multi-agent-decentralized-pattern](https://cdn.hutusi.com/images/weeklies/17/openai-multi-agent-decentralized-pattern.jpg)
...
![manus-design-around-kv-cache](https://cdn.hutusi.com/images/weeklies/17/manus-design-around-kv-cache.jpg)
...
![manus-mask-not-remove](https://cdn.hutusi.com/images/weeklies/17/manus-mask-not-remove.jpg)
...
![manus-use-file-system-as-context](https://cdn.hutusi.com/images/weeklies/17/manus-use-file-system-as-context.jpg)
...
![manus-attention-through-recitation](https://cdn.hutusi.com/images/weeklies/17/manus-attention-through-recitation.jpg)
...
![manus-keep-wrong-stuff-in](https://cdn.hutusi.com/images/weeklies/17/manus-keep-wrong-stuff-in.jpg)
...
![manus-not-few-shotted](https://cdn.hutusi.com/images/weeklies/17/manus-not-few-shotted.jpg)
