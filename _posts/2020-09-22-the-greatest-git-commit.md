...
![Git simple objects model]({{site.images_baseurl}}/git-object-model-tree.png)
...
![Git Working tree, staging area, and Git directory.]({{site.images_baseurl}}/git-working-tree-staging-area-git-repo.png)
