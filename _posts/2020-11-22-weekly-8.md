...
HN 于2007年面试，保罗·格雷厄姆(Paul Graham)用 Arc(格雷厄姆设计的一种 Lisp 方言)写成。起初，格雷厄姆给他起名为 Startup News, 但后来考虑到创业的话题过于狭窄，就放宽到黑客(hacker, 此黑客非计算机网络犯罪的骇客，参见格雷厄姆的书《黑客与画家》)领域，提供“有趣”的信息聚合服务。
