...
现在应该很少人怀疑 AI 的生产力了吧，而从去年的 Claude Code + Opus-4.5 组合的强大编程能力则直接刷新了很多人的认知，我也是在年底体验后[惊叹不已](https://hutusi.com/articles/2025-review)。我用 Claude Code 做了几个应用，后来又尝试 Gemini CLI, 并用 Gemini CLI 也做了静态网站的程序，用在了工作的洞察周刊中。过程中一行代码没有写，甚至连 `Git Commit` 信息也是由 Gemini CLI 填写的，我把[代码开源在了 GitHub 上](https://github.com/hutusi/amytis)，如果有想要建博客或知识库、文档网站的同学推荐取用，我在 Vercel 上也部署了 [Live Demo](https://amytis.vercel.app/) 可以体验效果。
