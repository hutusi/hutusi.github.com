...
subtitle: "MCP 的起源、基本概念及内部原理、生态和发展"
date: "2025-09-08 00:05:00 +0800"
image: weeklies/19-mcp-overview.jpg
---

本文为周刊第19期，前期周刊参见：[周刊系列](/weeklies/)。

最近学习了 MCP(Model Context Protocol, 模型上下文协议)的一系列文档、书籍和文章，便在本期周刊梳理总结下相关知识，一起来学习了解下 MCP 究竟是什么，能解决什么问题，基本概念和内部原理是什么，以及生态和当前的发展情况。

受[万维钢的启发](/weeklies/18)，从本篇周刊开始，我会计算每篇文章的“思维密集度”，也就是花在写文章的时间（包括前期相关资料收集、学习的时间），除以阅读文章所需的时间，所得到的值。本文的思维密集度 = 40小时（前期学习估算时长）+ 10小时（写作）÷ 18分钟（阅读本文时长）≈ 167.
...
MCP官方没有推出MCP应用市场，只是在GitHub上用一个[README收集了MCP服务器清单](https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#model-context-protocol-servers)，不过有很多第三方的MCP市场，如 smithery.ai, MCP.so, MCPMarket.com, modelscope.cn/mcp 等。其中，目前可能是MCP服务器收录最多的mcp.so 来自于一位网名为艾逗笔的技术极客之手，他从腾讯离职后做独立开发。去年11月底，Anthropic发布MCP，艾逗笔认真阅读官方文档后[突发奇想](https://web.okjike.com/u/35224A78-8B11-469E-B307-16B58688FBEC/post/675287728dc1346967bf59a5)，觉得可以建一个MCP的导航站，于是立马上手，花了两个小时mcp.so 就上线了，不得不说，在AI时代有想法又能够动手的话生产效率是惊人的。
