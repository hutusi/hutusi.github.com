...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-50 to-gray-100 border-t border-[var(--border)] mt-20">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-[var(--foreground-secondary)] leading-relaxed max-w-sm">
        ...
        {/* Social icons */}
        <div className="flex items-center justify-center gap-3 py-6 border-t border-[var(--border)]">
          {siteConfig.social.github && (
            <a
              href={siteConfig.social.github}
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 text-gray-500 hover:bg-[var(--accent)] hover:text-white transition-all"
              aria-label="GitHub"
            >
